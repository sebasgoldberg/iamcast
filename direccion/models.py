...
class Direccion(models.Model):
  ...
  estado = ChainedForeignKey(Region, chained_field="pais", chained_model_field="country",on_delete=models.PROTECT, verbose_name=ugettext_lazy(u'Estado'),null=True, blank=False)
  ciudad = ChainedForeignKey(City, chained_field="estado", chained_model_field="region",on_delete=models.PROTECT, verbose_name=ugettext_lazy(u'Cidade'),null=True, blank=False)
